...
class RegistrationSystemTest extends TestCase
{
     ...
     */
    private function createTestTool(string $name): McpTool
    {
     ...
     */
    private function createTestResource(string $name): McpResource
    {
        return new class($name) extends McpResource
        {
     ...
     */
    private function createTestPrompt(string $name): McpPrompt
    {
        return new class($name) extends McpPrompt
        {
            protected string $name;
