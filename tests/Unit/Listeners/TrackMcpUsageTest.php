...
/**
 * @file tests/Unit/Listeners/TrackMcpUsageTest.php
 *
 * @description Unit tests for TrackMcpUsage listener
 *
 * @category Testing
 *
 * @coverage \JTD\LaravelMCP\Listeners\TrackMcpUsage
 *
...
#[CoversClass(TrackMcpUsage::class)]
#[Group('ticket-027')]
#[Group('listeners')]
class TrackMcpUsageTest extends UnitTestCase
{
    private TrackMcpUsage $listener;

    protected function setUp(): void
    {
        parent::setUp();
        $this->listener = new TrackMcpUsage;
    }

    #[Test]
    public function it_constructs_successfully(): void
    {
        $this->assertInstanceOf(TrackMcpUsage::class, $this->listener);
    }
